...
const tempretaure = document.querySelector('.temp');
const humidity = document.querySelector('.humidity');

const apiLink = 'https://api.openweathermap.org/data/2.5/weather?q=';
const apiKey = '&APPID=02017d506ac5777d8266213c70e2ebe9';
...
url = apiLink + city + apiKey + units;
    ...
    axios.get(url)
        .then(res => {
            ...
            tempretaure.textContent = Math.floor(temp) + '°C';
            ...
            photo.setAttribute('src', "..//Weather App/img/ice.png");
            } else if (status.id >= 700 && status.id < 800) {
            photo.setAttribute('src', "..//Weather App/img/fog.png");
